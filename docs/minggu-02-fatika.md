...
<img src="image/Php artisan tentang.png" width="500">
...
Berdasarkan percobaan BREAK yang telah dilakukan, dapat dipahami bahwa bagian-bagian dalam Laravel saling berhubungan dalam menjalankan sebuah aplikasi. Perubahan atau kesalahan pada method HTTP, route, view, asset, maupun parameter dapat memengaruhi proses dan menimbulkan error. Melalui percobaan ini, dapat diketahui bahwa penggunaan Laravel tidak hanya membutuhkan kemampuan dalam menulis kode, tetapi juga pemahaman mengenai alur request hingga menghasilkan response.
